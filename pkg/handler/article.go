...
// @Summary ArticleFavorite an article
// @Description ArticleFavorite an article. Auth is required
// @ID favorite
...
// @Summary ArticleUnfavorite an article
// @Description ArticleUnfavorite an article. Auth is required
// @ID unfavorite
// @ArticleTags favorite
// @Accept  json
// @Produce  json
